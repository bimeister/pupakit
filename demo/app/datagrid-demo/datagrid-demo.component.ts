...
import { DatagridColDef } from '../../../src/internal/declarations/interfaces/datagrid-col-def.interface';
...
export class DatagridDemoComponent implements AfterViewInit {
  ...
  public readonly rowData: any[] = [
    ...
    { make: 'Porsche', model: 'Boxter Boxter Boxter Boxter Boxter Boxter ', price: 72000 },
    { make: 'Toyota', model: 'Celica', price: 35000 },
    { make: 'Ford', model: 'Mondeo', price: 32000 },
  ...
  public ngAfterViewInit(): void {
    const colDefs: DatagridColDef[] = [
      { headerName: 'Make', colId: 'make', field: 'make', isAvailableInSettings: false },
      {
        headerName: 'Model',
        colId: 'model',
        field: 'model',
        ...
        autoHeight: true,
        isAvailableInSettings: true
      },
      { headerName: 'Price', colId: 'price', field: 'price', isAvailableInSettings: true }
    ];

    this.manipulator.setColDefs(colDefs, this.userActionsCellTemplate);
