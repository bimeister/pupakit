...
const BASE_REQUEST_PATH: string = 'button-round-demo/examples';

@Component({
  selector: 'demo-button',
  templateUrl: './button-round-demo.component.html',
  styleUrls: ['./button-round-demo.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.Emulated,
})
export class ButtonRoundDemoComponent {
