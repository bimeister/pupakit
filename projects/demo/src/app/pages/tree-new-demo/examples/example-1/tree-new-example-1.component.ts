...
@Component({
  selector: 'demo-tree-new-example-1',
  templateUrl: './tree-new-example-1.component.html',
  styleUrls: ['./tree-new-example-1.component.scss'],
  encapsulation: ViewEncapsulation.Emulated,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TreeNewExample1Component implements OnDestroy {
