...
const BASE_REQUEST_PATH: string = 'infinity-scroller-demo/examples';

@Component({
  selector: 'demo-infinity-scroller-demo',
  templateUrl: './infinity-scroller-demo.component.html',
  styleUrls: ['./infinity-scroller-demo.component.scss'],
  encapsulation: ViewEncapsulation.Emulated,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class InfinityScrollerDemoComponent {
