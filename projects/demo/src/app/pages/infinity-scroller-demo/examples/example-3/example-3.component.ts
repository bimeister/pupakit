...
@Component({
  selector: 'demo-infinity-scroller-example-3',
  templateUrl: './example-3.component.html',
  styleUrls: ['./example-3.component.scss'],
  encapsulation: ViewEncapsulation.Emulated,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class InfinityScrollerExample3Component implements OnInit, OnDestroy {
  ...
  public readonly bufferSize: number = BUFFER_SIZE;
