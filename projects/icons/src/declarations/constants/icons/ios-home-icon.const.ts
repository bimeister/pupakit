...
export const iosHomeIcon: IconDefinition = {
  name: 'ios-home',
...
<g>
	<path d="M258.5,104.1c-1.5-1.2-3.5-1.2-5,0l-156,124.8c-0.9,0.8-1.5,1.9-1.5,3.1v230c0,1.1,0.9,2,2,2h108c1.1,0,2-0.9,2-2V322
		c0-1.1,0.9-2,2-2h92c1.1,0,2,0.9,2,2v140c0,1.1,0.9,2,2,2h108c1.1,0,2-0.9,2-2V232c0-1.2-0.6-2.4-1.5-3.1L258.5,104.1z"/>
	<path d="M458.7,204.2l-189-151.4C265.9,49.7,261,48,256,48c-5,0-9.9,1.7-13.7,4.8L160,119.7V77.5c0-1.1-0.9-2-2-2H98
