...
export const logoMarkdownIcon: IconDefinition = {
  name: 'logo-markdown',
...
<g transform="translate(96 48)">
	<g id="icon-markdown">
		<path d="M351.659,48H-31.659C-49.496,48-64,62.484-64,80.308v255.349C-64,353.493-49.496,368-31.659,368h383.318
