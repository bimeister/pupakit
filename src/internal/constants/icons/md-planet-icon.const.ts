...
export const mdPlanetIcon: IconDefinition = {
  name: 'md-planet',
...
<g>
	<path d="M135.7,151c-2.5,3-4.9,6-7.2,9.2c32.2,36.3,76.1,76.5,124.2,113.7c37.8,29.2,76.3,55.2,111.4,75.1
	...
	<path d="M418.2,326.8c-4.1,11-7.4,17.5-7.4,17.5c18.2,21.1,24.6,33.9,31.9,46.4c2.4,4.1,7.4,13.1,0.9,12.4
