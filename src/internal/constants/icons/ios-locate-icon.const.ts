...
export const iosLocateIcon: IconDefinition = {
  name: 'ios-locate',
...
<g>
	<path d="M395.3,259c-0.3-1.2-0.4-2.4-0.3-3.6c0-0.8,0.2-1.6,0.3-2.4c-0.4,0.9-0.6,2-0.6,3C394.8,257.1,395,258.1,395.3,259z"/>
	<path d="M459.4,270H409c-6.7,0-12.3-4.7-13.7-11c-0.3-0.9-0.5-1.9-0.5-3c0-1.1,0.2-2.1,0.6-3c1.4-6.4,7.3-11,14.1-11h49.9
