...
export const iosImagesIcon: IconDefinition = {
  name: 'ios-images',
...
<g>
	<path d="M262.3,199.2c-1.6-2.8-5.6-3.2-7.7-0.7l-91.9,122.2c-2.5,2.9-0.6,7.4,3.2,7.7l161.1,14c3.8,0.3,6.4-3.8,4.5-7.1
		L262.3,199.2z"/>
	<path d="M367.2,264.1c-1.6-2.8-5.6-3.2-7.7-0.7l-24.8,25.1c-1.3,1.5-1.5,3.7-0.5,5.4l25.4,49.5c0.8,1.3,2.1,2.2,3.7,2.3l44.9,3.9
		c3.8,0.3,6.4-3.8,4.5-7.1L367.2,264.1z"/>
	<path d="M378.1,224.4c11.2-0.1,20.9-8.3,23-19.2c2.8-14.8-8.6-28.3-23.7-28.1c-11.2,0.1-20.9,8.3-23,19.2
		C351.6,211.1,363,224.6,378.1,224.4z"/>
	<path d="M455.2,129.3l-65.8-5.7l-6.1-67c-1.3-14.9-14.5-25.9-29.5-24.5L56.7,58.9c-14.9,1.3-25.9,14.5-24.6,29.4l26.8,296.5
